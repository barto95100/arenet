...
func runRestoreCLI(ctx context.Context, logger *slog.Logger, cfg *appconfig.Config) error {
	...
	logger.Info("config restored",
		...
		"extras_imported", report.ExtrasImported,
		"managed_domains_imported", report.ManagedDomainsImported,
		"error_templates_imported", report.ErrorTemplatesImported,
		"alert_channels_imported", report.AlertChannelsImported,
		"alert_rules_imported", report.AlertRulesImported,
		"api_tokens_imported", report.APITokensImported,
