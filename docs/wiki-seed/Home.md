...
| `ARENET_GEOIP_ASN_MMDB` | `GeoLite2-ASN.mmdb` next to the City database | Path to the GeoLite2-ASN database used by the [ASN rules](Country-Block#asn-networks-v2280) (auto-downloaded with the City database). |
